...
describe('Process The Task', () => {
  ...
  describe('Basic Task Management', () => {
  ...
  describe('Advance Task Management', () => {
    it('#1 should add task, if user given single string', async () => {
      command = 'join wedding party at Raffles this Sunday at 9pm';
      ...
      const resultTaskManagement = await taskService.processSingleString(command);
    ...
    it('#2 should add task, if user given single string', async () => {
      command = 'go swimming at Community Centre 9am tomorrow';
